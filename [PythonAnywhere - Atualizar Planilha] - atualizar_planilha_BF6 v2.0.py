...
# Importe esta biblioteca no início do seu arquivo
from google.oauth2.service_account import Credentials

def authenticate_google_sheets():
    """Autentica com a API do Google usando uma Conta de Serviço."""
    try:
        # Caminho para o arquivo JSON da sua Conta de Serviço no PythonAnywhere
        ...
        print(f"❌ ERRO CRÍTICO: O arquivo de chave '{SERVICE_ACCOUNT_FILE}' não foi encontrado.")
        print("   Verifique se o nome do arquivo está correto e se ele foi enviado para o PythonAnywhere.")
        return None
    except Exception as e:
        print(f"❌ ERRO CRÍTICO ao autenticar: {e}")
        return None
